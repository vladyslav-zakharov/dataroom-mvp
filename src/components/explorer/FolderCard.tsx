 ...
 * Clicking the main area navigates into the folder.
...
const FolderCard: FC<Props> = ({ node, onClick, onRename, onDelete }) => {
  return (
    <div className="group flex w-full items-center gap-3 rounded-lg border border-border bg-card px-3 py-2.5 text-sm transition-colors hover:bg-accent hover:text-accent-foreground">
      ...
      <button
        type="button"
        className="flex flex-1 items-center gap-3 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded"
